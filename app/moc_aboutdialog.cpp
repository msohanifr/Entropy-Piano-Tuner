...
template <> constexpr inline auto AboutDialog::qt_create_metaobjectdata<qt_meta_tag_ZN11AboutDialogE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        // Slot 'onOpenAboutUrl'
        QtMocHelpers::SlotData<void(QUrl)>(1, 2, QMC::AccessPrivate, QMetaType::Void, {{
            { 0x80000000 | 3, 4 },
        }}),
        // Slot 'onOpenAboutLink'
...
void AboutDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->onOpenAboutUrl((*reinterpret_cast<std::add_pointer_t<QUrl>>(_a[1]))); break;
        case 1: _t->onOpenAboutLink((*reinterpret_cast<std::add_pointer_t<QString>>(_a[1]))); break;
        default: ;
        }
    }
}
